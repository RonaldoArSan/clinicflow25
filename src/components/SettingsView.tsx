...
const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  const handleCepChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setLocalSettings({ ...localSettings, cep: newCep });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalSettings({ ...localSettings, cnes: e.target.value })
                  }
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    darkMode
                      ? "bg-gray-700 border-gray-600 text-gray-200"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalSettings({
                      ...localSettings,
                      technicalManagerCrm: e.target.value,
                    })
                  }
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    darkMode
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalSettings({
                      ...localSettings,
                      technicalManagerCpf: e.target.value,
                    })
                  }
                  className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                    darkMode
            ...
            <div className="space-y-6">
              ...
              >
                ...
                >
                  ...
                  <li>
                    • O logo será usado em receituários, prontuários e
                    documentos
                  </li>
                  <li>
                    • Certifique-se de que seja legível em tamanhos pequenos
                  </li>
                </ul>
              </div>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  Informações legais, avisos ou instruções que aparecerão no
              ...
              <div>
                ...
                >
                  Informações sobre a clínica que podem ser incluídas em
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h3 className="text-lg font-bold text-gray-800">
                          {localSettings.letterhead ||
                            localSettings.fantasyName}
                        </h3>
                        <p className="text-sm text-gray-600">
                          {localSettings.address}, {localSettings.number} -{" "}
                          {localSettings.district}
                        </p>
                        <p className="text-sm text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                ...
                >
                  <div className="flex items-center space-x-3">
                    <div
                      className={`w-8 h-8 bg-${plan.color}-100 rounded-full flex items-center justify-center`}
                    >
                      <ShieldCheck
                        className={`w-5 h-5 text-${plan.color}-600`}
                      />
                    </div>
                    <span
                      className={`${
