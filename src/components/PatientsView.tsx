...
const PatientsView: React.FC<PatientsViewProps> = ({
  ...
  const [healthPlanFilter, setHealthPlanFilter] =
    React.useState("Todos os convênios");
  ...
  const filteredPatients = patients.filter((patient) => {
    ...
    const matchesHealthPlan =
      healthPlanFilter === "Todos os convênios" ||
      patient.healthPlan === healthPlanFilter;
    const matchesStatus =
      statusFilter === "Todos os status" ||
      patient.status === statusFilter.toLowerCase();

    return matchesSearch && matchesHealthPlan && matchesStatus;
  });
  ...
  const handleDownloadReport = () => {
    ...
    link.setAttribute(
      "download",
      `relatorio_pacientes_${new Date().toISOString().split("T")[0]}.csv`
    );
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Buscar pacientes (Nome ou CPF)..."
                value={searchTerm}
            ...
            <select
              value={healthPlanFilter}
              onChange={(e) => setHealthPlanFilter(e.target.value)}
      ...
      {selectedPatient && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div
            ...
            } rounded-lg p-6 max-w-5xl w-full max-h-[90vh] overflow-y-auto transition-colors`}
          >
